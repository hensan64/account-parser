...
public class LibTest {
	...
	public final void testPrintListData() {
		...
		stringList
				.add("{year: 2013, month: 01, day: 12, prefix: SB, memo: Computer Store 1, type: debit, value: 1234567.98}");
		stringList
				.add("{year: 2014, month: 02, day: 13, prefix: CB, memo: Computer Store 2, type: credit, value: 9876543.21}");
		final TransactionData data1 = new TransactionData.Builder()
				.setYear("2013").setMonth("01").setDay("12").setPrefix("SB")
				.setMemo("Computer Store 1").setType("debit")
				.setValue("1234567.98").build();
		final TransactionData data2 = new TransactionData.Builder()
				.setYear("2014").setMonth("02").setDay("13").setPrefix("CB")
				.setMemo("Computer Store 2").setType("credit")
				.setValue("9876543.21").build();
